...
public final class XmlTagConstants
{
	...
	public static final String TAG_COMMENT_VIEW = "comment_view";
	...
	public static final String TAG_ENTITY_VIEWS = "entity_views";

	public static final String TAG_ER_DIAGRAM = "er_diagram";

	public static final String TAG_FK_RELATIONSHIP_END = "fk_relationship_end";

	public static final String TAG_FOREIGN_KEY = "foreign_key";

	public static final String TAG_LINK = "link";

	public static final String TAG_LINK_VIEWS = "link_views";

	public static final String TAG_LINKS = "links";

	public static final String TAG_MODEL = "model";

	public static final String TAG_PK_RELATIONSHIP_END = "pk_relationship_end";

	public static final String TAG_PRIMARY_KEY = "primary_key";

	public static final String TAG_RELATIONSHIP = "relationship";

	public static final String TAG_RELATIONSHIP_VIEW = "relationship_view";

	public static final String TAG_RELATIONSHIP_VIEWS = "relationship_views";
