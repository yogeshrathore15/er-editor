...
public class Main {
	...
	private static JComponent createDiagramEditor() {
		...
		EntityView entityView1 = diagramEditor.addEntity(new Entity(
				"Foo entity "), 20, 20);
		diagramEditor.add(entityView1);
		EntityView entityView2 = diagramEditor.addEntity(new Entity(
				"Bar entity"), 150, 10);
		diagramEditor.add(entityView2);
		diagramEditor.add(diagramEditor.addEntity(new Entity(
				"Buzz entity"), 260, 10));
		diagramEditor.add(diagramEditor.addEntity(new Entity(
				"Long named entity"), 260, 200));
		diagramEditor // O_O
