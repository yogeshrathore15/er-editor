...
public class AddFKRelationshipCommand implements ICommand {
    ...
    public AddFKRelationshipCommand(final DiagramEditor diagramEditor, EntityView ev1,
            EntityView ev2) {
    ...
    public void doIt() {
        if (relationshipView == null) {
            relationshipView = diagramEditor.addFKRelationship(entityView1,
                    entityView2);
        } else {
