...
public class SelectElementTool extends ToolAdapter {
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1) {
            ...
            nothingSelected = nothingSelected
                    && selectViews(e, diagramEditor.getDiagram()
    ...
    private void synchronizeOutlinesWithSelection() {
    ...
    public void mouseReleased(MouseEvent e) {
        if (e.getButton() == MouseEvent.BUTTON1) {
            if (e.isShiftDown()
                    ...
                    && getSelectedItems().getFirst().containsPoint(e.getX(),
                            e.getY())) {
                ...
                Point p = CommonUtils
                        .getRightBottomPoint(getSelectedItems().asSet());
