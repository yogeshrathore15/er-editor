...
public class RelationshipTest {
    ...
    public void testRelationship() {
        ...
        Relationship relationship = new Relationship(new PKRelationshipEnd(entity1,
                ZERO_OR_MORE, ""), new PKRelationshipEnd(entity2, ZERO_OR_MORE, ""));
    ...
    public void testSetFirstEnd() {
        Relationship relationship = new Relationship(new PKRelationshipEnd(
                new Entity(""), ZERO_OR_MORE, null), new PKRelationshipEnd(
                new Entity(""), ZERO_OR_MORE, null));
        Entity entity1 = new Entity("1");
        Entity entity2 = new Entity("2");
