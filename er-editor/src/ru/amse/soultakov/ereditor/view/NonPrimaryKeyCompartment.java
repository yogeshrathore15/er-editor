...
class NonPrimaryKeyCompartment extends AttributesCompartment
{
	...
	public Rectangle2D getContentBounds(Graphics2D graphics)
	{
		...
		bounds.setRect(0, 0, bounds.getWidth() + ADDITIONAL_COLUMN_WIDTH, bounds.getHeight());
		return bounds;
	}
	...
	{
		graphics.drawLine(getAdditionalColumnX(), getAbsoluteY(), getAdditionalColumnX(),
				getAbsoluteY() + getHeight(graphics));
