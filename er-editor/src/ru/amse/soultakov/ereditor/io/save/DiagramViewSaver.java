...
class DiagramViewSaver {
    ...
    public DiagramViewSaver(final Diagram diagram,
            final SavingIdManager savingIdManager) {
    ...
    private Content getCommentViewsElement() {
        ...
        for (CommentView cv : diagram.getCommentViews()) {
            ...
            element.setAttribute(ATTR_DIAGRAM, savingIdManager
                    .getId(cv.getDiagram()));
            element.setAttribute(ATTR_COMMENT, savingIdManager
                    .getId(cv.getComment()));
    ...
    private Content getRelationshipViewsElement() {
        ...
        for (RelationshipView rv : diagram.getRelationshipViews()) {
            ...
            element.setAttribute(ATTR_DIAGRAM, savingIdManager
                    .getId(rv.getDiagram()));
            element.setAttribute(ATTR_RELATIONSHIP, savingIdManager.getId(rv
                    .getRelationship()));
            root.addContent(element);
        }
        return root;
