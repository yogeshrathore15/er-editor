...
class EntitiesLoader {
    ...
    private FKAttribute loadFkAttributeSecond(Element element) {
        FKAttribute attribute = (FKAttribute) loadingIdManager.getObject(element
                .getAttributeValue(ATTR_ID));
        attribute.setEntity((Entity) loadingIdManager.getObject(element
                .getAttributeValue(ATTR_FOREIGN_ENTITY)));
        attribute.setAttribute((AbstractAttribute) loadingIdManager
                .getObject(element.getAttributeValue(ATTR_FOREIGN)));
        return attribute;
    }
                ...
                for (Object attr : pk.getChildren(TAG_ATTRIBUTE)) {
                    if (attr instanceof Element) {
                        ...
                        AbstractAttribute attribute = (AbstractAttribute) loadingIdManager
                                .getObject(attrElement.getAttributeValue(ATTR_ID));
                        if (attribute != null) {
    ...
    private FKAttribute loadFkAttributeFirst(Element element) {
        ...
        FKAttribute attribute = new FKAttribute(name, notNull, defaultValue, null,
                null);
